...
def _ensure_db():
    """Build DB if needed (thread-safe)."""
...
# Build at import time — no Streamlit UI calls
_ensure_db()


def get_connection():
    """Return a DuckDB connection. Each call returns a fresh connection for thread safety."""
